 ...
 */
final class Version20260331092508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE announce (id_annonce INT AUTO_INCREMENT NOT NULL, titre VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, type VARCHAR(255) NOT NULL, nb_pieces INT NOT NULL, prix DOUBLE PRECISION NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, equipements VARCHAR(255) DEFAULT NULL, regle VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, disponibilite_debut DATE NOT NULL, disponibilite_fin DATE DEFAULT NULL, adresse VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, code_postal VARCHAR(10) DEFAULT NULL, surface DOUBLE PRECISION DEFAULT NULL, is_validated TINYINT DEFAULT 0 NOT NULL, id_utilisateur INT NOT NULL, INDEX IDX_E6D6DD7550EAE44 (id_utilisateur), PRIMARY KEY (id_annonce)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE announce_picture (id_photoAnnonce INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, date_creation DATETIME NOT NULL, id_annonce INT NOT NULL, INDEX IDX_2FC49EC828C83A95 (id_annonce), PRIMARY KEY (id_photoAnnonce)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, type VARCHAR(255) NOT NULL, is_read TINYINT NOT NULL, created_at DATETIME NOT NULL, recipient_id INT NOT NULL, INDEX IDX_BF5476CAE92F8F78 (recipient_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE reservation (id_reservation INT AUTO_INCREMENT NOT NULL, date_debut DATE NOT NULL, date_fin DATE DEFAULT NULL, statut VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, id_annonce INT NOT NULL, id_utilisateur INT NOT NULL, INDEX IDX_42C8495528C83A95 (id_annonce), INDEX IDX_42C8495550EAE44 (id_utilisateur), PRIMARY KEY (id_reservation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE user_contacts (user_source_id INT NOT NULL, user_target_id INT NOT NULL, INDEX IDX_D3CDF17395DC9185 (user_source_id), INDEX IDX_D3CDF173156E8682 (user_target_id), PRIMARY KEY (user_source_id, user_target_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE user_likes (id INT AUTO_INCREMENT NOT NULL, id_utilisateur INT NOT NULL, id_annonce INT NOT NULL, INDEX IDX_AB08B52550EAE44 (id_utilisateur), INDEX IDX_AB08B52528C83A95 (id_annonce), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CAE92F8F78 FOREIGN KEY (recipient_id) REFERENCES user (id_utilisateur)');
