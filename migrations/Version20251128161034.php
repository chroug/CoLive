...
final class Version20251128161034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis ADD CONSTRAINT FK_8F91ABF028C83A95 FOREIGN KEY (id_annonce) REFERENCES annonce (id_annonce)');
        ...
        $this->addSql('ALTER TABLE liker ADD CONSTRAINT FK_3ECD7EEB28C83A95 FOREIGN KEY (id_annonce) REFERENCES annonce (id_annonce)');
        $this->addSql('ALTER TABLE photo_annonce ADD CONSTRAINT FK_C3B5846828C83A95 FOREIGN KEY (id_annonce) REFERENCES annonce (id_annonce)');
    }
